...
// import { packageFilters, packages, type SafariPackage } from "@/lib/packages-data";
...
//             <li key={h} className="flex items-start gap-2.5 text-[13px] leading-snug text-ink/85">
...
//   const [active, setActive] = useState<typeof packageFilters[number]["value"]>("all");
