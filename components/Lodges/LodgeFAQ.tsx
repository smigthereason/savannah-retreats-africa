...
import { lodgeFaqs } from "@/lib/lodges-data";

export default function LodgeFAQ() {
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[0.8fr_1.2fr] md:gap-20">
          <div>
            ...
            <p className="mt-6 max-w-sm text-[15px] leading-relaxed text-ink">
              The practical questions we're asked before a first booking.
              Anything else — call the reservation line above or send us
              your dates.
            </p>
          </div>
